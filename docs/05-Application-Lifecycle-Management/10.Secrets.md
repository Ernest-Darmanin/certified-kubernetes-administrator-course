...
> [!NOTE]
> Make sure that when you name the secret file in the Pod definition, that the name will be indented **`6 times`** and will be placed under the **`e`** of _secretRef_  
